...
function loadImage() {
    ...
    var text = "<img style=\"border-radius:10px; margin:10px auto;\" src=\"" + imageUrl + "\" >"
...
function byoIntro() {
    ...
    var byoCourses = document.getElementById('addedClass').value;
    ...
    var introText = "<figure><img style=\"border-radius:10px;\" src=\"" + imageUrl + "\" ></figure>" +
